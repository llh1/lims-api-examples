  ...
  module PostExtractionTubeRacking
    ...
    def post_extraction_tube_racking_workflow_for(type)
      @parameters[:post_extraction].each do |order_nb, p|
        ...
        # =================================== 
        API::new_stage("[Order #{order_nb}] #{type} post extraction tube racking. Create new tubes. Add them in the order. Transfer #{type} extracted tubes into 2D tubes. Then rack the 2D tubes in a tube rack.")
        # =================================== 
